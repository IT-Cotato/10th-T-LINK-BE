...
public class CounselingLogController {
    ...
    @GetMapping
    public ResponseEntity<BaseResponse<?>> getCounselingLogs(
    ...
    public ResponseEntity<BaseResponse<?>> getCounselingLog(
            @PathVariable(value = "counselingLogId") @IdValidation Long counselingLogId) {
    ...
    public ResponseEntity<BaseResponse<?>> modifyCounselingLog(
            @PathVariable(value = "counselingLogId") @IdValidation Long counselingLogId,
            @RequestBody @Validated CounselingLogSaveRequest counselingLogSaveRequest) {
    ...
    public ResponseEntity<BaseResponse<?>> removeCounselingLog(
            @PathVariable(value = "counselingLogId") @IdValidation Long counselingLogId) {
